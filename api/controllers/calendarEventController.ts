...
import { EventsSummaryDto } from "../models/EventsSummaryDto";
...
export class CalendarEventController extends ApiControllerCrud<CalendarEventDto, CalendarEventFilter> {
  ...
  async getCalendarEvents(opts?: any, signal?: AbortSignal): Promise<EventsSummaryDto | null> {
    return await this.process<EventsSummaryDto>(this.get("fetch", { params: opts, signal }));
  }
